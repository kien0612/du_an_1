                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                ...
                                <div class="widget-short_desc">
                                    <p>Chào mừng bạn đến với shop của chúng tôi
                                    </p>
                                </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="footer-widgets">
                                            <ul>
                                                ...
                                                <li><a href="#">Sản phẩm trending</a></li>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="footer-widgets_info">
                                            ...
                                            <div class="widgets-essential_stuff">
                                                <ul>
                                                    <li class="hiraola-address"><i class="ion-ios-location"></i><span>Địa chỉ:</span> Trường cao đẳng FPT Polytechnic , Trịnh Văn Bô , Nam Từ Liêm , Hà Nội</li>
                                                    <li class="hiraola-phone"><i class="ion-ios-telephone"></i><span>
                                                            Hotline:</span> <a href="#">+123 321 345</a>
                                                    </li>
                                                    <li class="hiraola-email"><i class="ion-android-mail"></i><span>Email:</span> <a href="#">nhom8@gmail.com</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="footer-bottom_area">
                <div class="container">
                    <div class="footer-bottom_nav">
                        <div class="row">
                                <div class="copyright">
                                    <span>Copyright &copy; 2022 <a href="index.php">Hiraola.</a> All rights reserved.</span>
                                </div>
        ...
        <!-- cái này không cần quan tâm kiểu phương thức nền trong -->
                            ...
                            <div class="col-xl-7 col-lg-6 col-md-6">
                                <div class="sp-content">
                                    ...
                                    <div class="hiraola-group_btn">
                                        <ul>
                                            <li><a href="index.php?act=giohang" class="add-to_cart">Cart To Cart</a></li>
                                            <li><a href="index.php?act=giohang"><i class="ion-android-favorite-outline"></i></a></li>
                                            <li><a href="index.php?act=giohang"><i class="ion-ios-shuffle-strong"></i></a></li>
                                        </ul>
                                    </div>
        ...
        <!-- Mirrored from htmldemo.net/hiraola/hiraola/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Nov 2023 13:59:18 GMT -->
